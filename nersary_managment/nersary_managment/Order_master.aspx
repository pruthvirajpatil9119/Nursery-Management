<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order_master.aspx.cs" Inherits="nersary_managment.Order_master" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_ord_id"   placeholder="ID"  class="form-control"  runat="server" ></asp:TextBox> <br />
              <asp:TextBox ID="txt_ord_date"  placeholder="Order Date"  class="form-control"  runat="server"></asp:TextBox> <br />
               <asp:Label ID="Label3" runat="server" Text="pay_id"></asp:Label> <br />
                 <asp:DropDownList ID="DropDownList1"   class="form-control"  runat="server"> 
                    </asp:DropDownList><br />
         <asp:TextBox ID="txt_grand_total"  placeholder="Grand Total"  class="form-control"  runat="server"></asp:TextBox> <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         ...
         <asp:Button ID="btn_save" runat="server"  class="btn alazea-btn mt-15"  Text="Save" OnClick="btn_save_Click" />
