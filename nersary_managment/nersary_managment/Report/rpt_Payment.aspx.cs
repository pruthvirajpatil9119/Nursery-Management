...
{
    public partial class rpt_Payment : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PlaceHolder1.Controls.Add(new LiteralControl("<table border='2px' id='bill' class='table'><tr><th>Id </th><th>Order Id</th><th> Amount</th><th>Date</th><th>Card_no</th></tr>"));
            while (dr.Read())
            {
