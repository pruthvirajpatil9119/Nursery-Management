<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Plant_Type_wise_Plant_Master.aspx.cs" Inherits="nersary_managment.Report.Plant_Type_wise_Plant_Master" %>
...
<body>
    ...
    <div class="breadcrumb-area">
        ...
        <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(alazea-gh-pages/img/bg-img/24.jpg);">
            <h2>Plant Type Wise Plant Matser</h2>
        </div>
