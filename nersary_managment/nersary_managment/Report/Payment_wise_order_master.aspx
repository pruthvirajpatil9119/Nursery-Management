<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment_wise_order_master.aspx.cs" Inherits="nersary_managment.Report.Payment_wise_order_master" %>
...
<body>
    ...
    <div class="breadcrumb-area">
        ...
        <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(alazea-gh-pages/img/bg-img/24.jpg);">
            <h2>Payment wise Order Master</h2>
        </div>
    ...
    <div>Payment Id
     <asp:DropDownList ID="DropDownList1" CssClass="form-control"  runat="server">
        ...
        <asp:Button ID="Button1" runat="server"  class="btn alazea-btn mt-15" OnClientClick="Export()" Text="Export" />
    </div>
    </form>
