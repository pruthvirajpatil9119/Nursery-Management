<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DateWisePayment.aspx.cs" Inherits="nersary_managment.Report.DateWisePayment" %>
...
<body>
    ...
    <form id="form1" runat="server">
                ...
                <asp:TextBox ID="txtfrom" CssClass="form-control"   placeholder="From Date" runat="server"></asp:TextBox><br />
            
                <asp:TextBox ID="txtto" CssClass="form-control" placeholder="To Date"  runat="server"></asp:TextBox><br />
           
                <asp:Button ID="btnshow" runat="server"  class="btn alazea-btn mt-15" onclick="btnshow_Click" Text="show" /><br />
            
                <asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder><br />
          
        <asp:Button ID="Button1" runat="server" OnClientClick="Export()"   class="btn alazea-btn mt-15" Text="Export" /><br />
