<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order_details.aspx.cs" Inherits="nersary_managment.Order_details" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function formValidator()
        {
            ...
            var qty= document.getElementById("txt_qty");
            var amt= document.getElementById("txt_amt");
            var gst= document.getElementById("txt_gst");
            

            if(notEmpty(rate ,"rate Must be given") &&  isNumeric(rate, "rate enter only digit for plant rate"))
            {
                if(notEmpty(qty ,"qty Must be given") &&  isNumeric(qty, "Please enter only digit for plant qty"))
                {
                    if(notEmpty(amt ,"amount Must be given") &&  isNumeric(amt, "Please enter only digit for plant amount "))
                    {
                        if(notEmpty(gst ,"gst Must be given"))
                        {
                             return true;
                        }
                    }
    ...
    <form id="form1" runat="server">
       <div class="container">
        <div class="row">
         ...
         <asp:TextBox ID="txt_ord_det_id"   placeholder="ID"  class="form-control"   runat="server" ></asp:TextBox>  <br />
         <asp:TextBox ID="txt_ord_id"   placeholder="Order ID"  class="form-control"   runat="server" ></asp:TextBox>  <br />
         <asp:TextBox ID="txt_plant_id"   placeholder="Plant Id"  class="form-control"   runat="server" ></asp:TextBox>  <br />
         <asp:TextBox ID="txt_rate"  placeholder="Rate"  class="form-control"  runat="server" ></asp:TextBox>  <br /></div> <div class="col-md-6">
         <asp:TextBox ID="txt_qty"   placeholder="Quantity"  class="form-control"   runat="server" ></asp:TextBox>  <br />
         <asp:TextBox ID="txt_amt"   placeholder="Amount"  class="form-control"   runat="server" ></asp:TextBox>  <br />
         <asp:TextBox ID="txt_GST"   placeholder="GST"  class="form-control"   runat="server" ></asp:TextBox>  <br />
         <asp:TextBox ID="txt_Total"  placeholder="Total"  class="form-control"   runat="server" ></asp:TextBox>  <br /></div>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
