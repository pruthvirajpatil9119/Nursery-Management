<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="nersary_managment.Payment" %>
...
<body>
    ...
    <div>
      ...
      <asp:TextBox ID="txt_pay_id"   placeholder="ID"  class="form-control"  runat="server"></asp:TextBox> <br />
            <asp:TextBox ID="TextBox1"    placeholder="Cust ID"  class="form-control"   runat="server"></asp:TextBox><br />
              <asp:TextBox ID="txt_pay_amt"  placeholder="Amount"  class="form-control"  runat="server"></asp:TextBox> <br />
            <asp:TextBox ID="txt_pay_date"  placeholder="Date"  class="form-control"  runat="server" ></asp:TextBox> <br />
           
                    <asp:TextBox ID="txt" runat="server"  placeholder="Card No"  class="form-control" TextMode="Password"  ></asp:TextBox> <br />
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   
               
                    <asp:Button ID="btn_save" runat="server"  class="btn alazea-btn mt-15"  OnClick="btn_save_Click" style="margin-left: 159px" Text="Save" />
