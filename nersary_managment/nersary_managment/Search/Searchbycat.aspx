<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Searchbycat.aspx.cs" Inherits="nersary_managment.Search.Searchbycat" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Button ID="Button1"  class="btn alazea-btn mt-15" runat="server" OnClick="Button1_Click" Text="Search" />
        <br />
        <br />
        <br />
