<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Searchdetails.aspx.cs" Inherits="nersary_managment.Search.Searchdetails" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Button ID="Button1"  class="btn alazea-btn mt-15" runat="server" OnClick="Button1_Click" Text="Add To Cart" />
        <br />
        <br />
        <br />
        No Of Plants&nbsp; <asp:DropDownList ID="DropDownList1" runat="server">
        </asp:DropDownList>
