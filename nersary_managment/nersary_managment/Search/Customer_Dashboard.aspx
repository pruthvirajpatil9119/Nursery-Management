<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer_Dashboard.aspx.cs" Inherits="nersary_managment.Search.Customer_Dashboard" %>
...
<body>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="alazeaNav">
                        ...
                        <!-- Nav Brand -->
                        <a href="index.html" class="nav-brand"><img  height="100px" width="200px"   src="alazea-gh-pages/img/go-green-png-5-transparent-1.png" alt=""></a>
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Search/Search_all.aspx">Search All</asp:HyperLink>
        <br />
        <br />
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Search/Searchbycat.aspx">Search By Type</asp:HyperLink>
