<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Showcart.aspx.cs" Inherits="nersary_managment.Search.Showcart" %>
...
<body>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="Customer_Dashboard.aspx">Customer Dashboard</a></li>
    ...
    <div>
     <asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder>
            ...
            <asp:Button ID="Button1" runat="server"  class="btn alazea-btn mt-15"   
               Text="Search Anathor Plant" onclick="Button1_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <asp:Button ID="Button2" runat="server"   class="btn alazea-btn mt-15"
